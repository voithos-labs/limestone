...
<style>
	/* The page and its scroller run edge to edge so the wheel works anywhere and the
       thumb rides the page's right edge; .view-inner is what holds the reading column. */
	.view-page {
		position: relative;
		display: flex;
