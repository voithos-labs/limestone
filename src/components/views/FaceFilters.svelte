<script lang="ts">
    ...
    $effect(() => {
        ...
        for (const leaf of leaves) {
            ...
            if (field.type === 'folder') {
                ...
                if (Array.isArray(leaf.value)) for (const v of leaf.value) if (typeof v === 'string') groupIds.add(v);
    ...
    function addByField(fieldId: string) {
        ...
        pendingFocusLeaf = face.additive_filter.children[face.additive_filter.children.length - 1] as FilterLeaf;
    }
