...
import { parseBlocksProofOfConcept, parseMarkdownProofOfConcept, serializeProofOfConceptDocument, } from "../core/parser/index.js";
...
test("Phase 0 parser PoC classifies the mixed fixture into expected block kinds", () => {
    ...
    assert.deepEqual(document.blocks.map((block) => block.kind), ["heading", "paragraph", "listItem", "listItem", "blockquote", "fencedCode", "thematicBreak"]);
