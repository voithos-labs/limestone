...
import { buildCstOwnershipProofOfConcept, buildDelimiterAccountingProof, buildRecoveryRegionProofs, validateCstOwnershipProof, } from "../core/cst/index.js";
import { BLOCKQUOTE_OWNERSHIP_FIXTURE, DELIMITER_ACCOUNTING_FIXTURE, LIST_TRIVIA_FIXTURE, PARAGRAPH_TRIVIA_FIXTURE, PARTIAL_LINK_FIXTURE, RAW_HTML_FIXTURE, UNCLOSED_FENCE_FIXTURE, } from "./fixtures/cst-poc-fixtures.js";
...
test("CST PoC recovery proofs preserve incomplete and opaque regions exactly", () => {
    ...
    assert.deepEqual(proofs.map((proof) => [proof.kind, proof.reason, proof.source]), [
