export const COMMONMARK_SUPPORTED_PARSER_CASES = [
    {
...
export const GFM_SUPPORTED_PARSER_CASES = [
    {
...
export const PRESERVE_ONLY_AND_FALLBACK_CASES = [
    {
...
export const PARSER_VALIDATION_CASE_GROUPS = [
    {
