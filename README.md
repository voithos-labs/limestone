...
> [!WARNING]
> Limestone is still in pre-release state, expect bugs. The editor migration is still underway, swapping over to Daniel's in-house [aragonite](https://github.com/voithos-labs/aragonite) editor.
